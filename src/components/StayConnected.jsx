  ...
  return (
    <section className="p-8 m-4 relative flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <a href="#" className="bg-blue-500 text-white p-3 rounded-full hover:scale-110 transition-transform">
          <FaFacebookF />
        </a>
        <a href="#" className="bg-purple-500 text-white p-3 rounded-full hover:scale-110 transition-transform">
          <FaInstagram />
        </a>
        <a href="#" className="bg-blue-800 text-white p-3 rounded-full hover:scale-110 transition-transform">
          <FaLinkedinIn />
        </a>
      </motion.div>
